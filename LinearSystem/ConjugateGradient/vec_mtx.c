...
/*-------------------------------------------------------------------
 * Procedure to perform vector addition.
 *    c = a + b.
 */
void vec_vec_add(double *c, double *a, double *b, int n)
{
   int   i;
...
/*-----------------------------------------------------------------
 * Procedure to perform vector substraction
 *   c = a - b.
 */
void vec_vec_sub(double *c, double *a, double *b, int n)
{
   int   i;
